        ...
        <div class="card-body p-4 p-lg-5">
            <div class="d-flex flex-column flex-lg-row justify-content-between gap-4">
                <div class="d-flex align-items-start gap-3">
                    ...
                    <div>
                        <div class="small text-white-50 mb-1">Ahli Khairat</div>
                        <h2 class="fw-bold mb-1">{{ $member->nama }}</h2>
                        <div class="text-white-50 mb-3">{{ $member->no_kp }}</div>
        ...
        <div class="col-12">
            <div class="card info-card">
                <div class="card-body p-4">
                    ...
                    @else
                        <div class="text-muted">Tiada tanggungan direkodkan.</div>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card info-card">
                <div class="card-body p-4">
                    ...
                    @else
                        <div class="text-muted">Tiada rekod bayaran.</div>
                    @endif
                </div>
            </div>
        </div>
